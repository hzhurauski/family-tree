...
export function DrawConnections(tree, blood) {
  ...
  for (var i = 0; i < 8; i++) {
    if (tree.Grand_has_parent[i] == true) {
      if (window.bloodFlag)
        if (window.bloodTree.Grand[i]) colorLine = colorBloodMuted
  ...
  for (var i = 0; i < 4; i++) {
    if (tree.Parent_has_brother[i] == true) {
      if (window.bloodFlag)
        if (window.bloodTree.Parent[i]) colorLine = colorBloodMuted
        else colorLine = colorMuted
      else colorLine = colorMuted
  ...
  for (var i = 0; i < 8; i++) {
    if (i % 2 == 0) {
      if (arrGrand[i] != null) {
        if (window.bloodFlag)
          if (window.bloodTree.Grand[i]) colorLine = colorBlood
  ...
  for (var i = 0; i < 4; i++) {
    if (arrParent[i] != null) {
      if (arrGrand[i * 2] == null && arrGrand[i * 2 + 1] == null) {
        ...
        if (window.bloodFlag)
          if (window.bloodTree.Parent[i]) colorLine = colorBlood
          else colorLine = colorDefault
        else colorLine = colorDefault
        drawLine(
          context,
  ...
  if (tree.Brothers != null && tree.Brothers.length > 0) {
    if (window.bloodFlag)
      if (window.bloodTree.Parent[0] || window.bloodTree.Parent[1])
  ...
  for (var i = 0; i < 2; i++) {
    ...
    if (arrParent[i * 2] == null && arrParent[i * 2 + 1] == null) {
      if (window.bloodFlag)
        if (
          window.bloodTree.Parent[i * 2] ||
          window.bloodTree.Parent[i * 2 + 1]
        )
  ...
  if (tree.Wife_2_has_parent) {
    if (window.bloodFlag)
      if (window.bloodTree.Wifes[1]) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
  ...
  if (tree.Wife_has_another_child != null) {
    for (var i = 0; i < 2; i++) {
      if (tree.Wife_has_another_child[i]) {
        if (window.bloodFlag)
          if (window.bloodTree.Wifes[i]) colorLine = colorBloodMuted
          else colorLine = colorMuted
        else colorLine = colorMuted
        drawHalf(
          context,
  ...
  if (tree.ChildWife_2 != null) {
    if (window.bloodFlag)
      if (window.bloodTree.Main) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
    ...
    if (window.bloodFlag)
      if (window.bloodTree.Main || window.bloodTree.Wifes[1])
        colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
  ...
  if (tree.Children == null) {
    ...
    if (window.bloodFlag)
      if (window.bloodTree.Main) colorLine = colorBlood
      else colorLine = colorDefault
    else colorLine = colorDefault
    draw(context, 270, 0, 575, 80, width, colorLine, false, dashLength, false)

    if (window.bloodFlag)
      if (window.bloodTree.Children[0]) colorLine = colorBlood
      else colorLine = colorDefault
    else colorLine = colorDefault
    ...
    if (tree.Wifes == null) {
      ...
      if (window.bloodFlag)
        if (window.bloodTree.Wifes[0]) colorLine = colorBlood
        else colorLine = colorDefault
      else colorLine = colorDefault
  ...
  if (tree.Children != null) {
    if (window.bloodFlag)
      if (window.bloodTree.Children[0]) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
  ...
  if (tree.Child_Another_has_sons) {
    if (window.bloodFlag)
      if (window.bloodTree.AnotherChild) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
