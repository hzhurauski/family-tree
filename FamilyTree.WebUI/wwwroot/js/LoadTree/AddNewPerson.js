...
export function AddNewPerson(event) {
    ...
    if (id != "wifeOne" && id != "sonOne") {
        window._createPersonData.PersonRelationType = window.window.PersonRelationTypes.Parent;
        ...
        if (id == "wifeOne") {
            window._createPersonData.PersonRelationType = window.PersonRelationTypes.Lover;
        }
        if (id == "sonOne") {
            window._createPersonData.PersonRelationType = window.PersonRelationTypes.Child;
