...
export function DrawConntecionsLittleTree(tree, blood) {
  ...
  if (arrGrand[0] != null || arrGrand[1] != null) {
    if (window.bloodFlag)
      if (window.bloodTree.Parent[0]) colorLine = colorBloodMuted
  ...
  if (arrGrand[2] != null || arrGrand[3] != null) {
    if (window.bloodFlag)
      if (window.bloodTree.Parent[1]) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
    drawLine(
      window.context,
  ...
  for (var i = 0; i < 2; i++) {
    if (i % 2 == 0) {
      if (arrParent[i] != null) {
        if (window.bloodFlag)
          if (window.bloodTree.Parent[0]) colorLine = colorBlood
      ...
      if (arrParent[i] != null) {
        if (window.bloodFlag)
          if (window.bloodTree.Parent[1]) colorLine = colorBlood
          else colorLine = colorDefault
        else colorLine = colorDefault
        draw(
          window.context,
  ...
  if (arrParent[2] != null || arrParent[3] != null) {
    if (window.bloodFlag)
      if (window.bloodTree.Wifes[0]) colorLine = colorBloodMuted
      else colorLine = colorMuted
    else colorLine = colorMuted
    drawLine(
      window.context,
  ...
  if (tree.Children == null) {
    ...
    if (window.bloodFlag)
      if (window.bloodTree.Main || window.bloodTree.Wifes[0])
        colorLine = colorBlood
      else colorLine = colorDefault
    else colorLine = colorDefault
    drawLine(
  ...
  if (tree.BrothersSons != null && tree.BrothersSons.length > 0) {
    if (tree.BrothersSons[0]) {
      if (window.bloodFlag)
        if (window.bloodTree.Brothers[0]) colorLine = colorBloodMuted
        else colorLine = colorMuted
      else colorLine = colorMuted
      drawLine(
        window.context,
