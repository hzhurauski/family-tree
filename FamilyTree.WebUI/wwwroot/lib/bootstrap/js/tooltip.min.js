;+(function (c) {
  ...
  b.prototype.getDelegateOptions = function () {
    ...
    this._options &&
      c.each(this._options, function (f, g) {
        if (e[f] != g) {
          d[f] = g
        }
      })
    ...
    if (this.hasContent() && this.enabled) {
      ...
      var i =
        typeof this.options.placement == 'function'
          ? this.options.placement.call(this, j[0], this.$element[0])
      ...
      if (s) {
        ...
        var q =
          this.options.container == 'body' ? window.innerWidth : h.outerWidth()
        var m =
  ...
  b.prototype.hide = function () {
    ...
    c.support.transition && this.$tip.hasClass('fade')
      ? h.one(c.support.transition.end, d).emulateTransitionEnd(150)
      : d()
  ...
  b.prototype.getCalculatedOffset = function (d, g, e, f) {
    return d == 'bottom'
      ? { top: g.top + g.height, left: g.left + g.width / 2 - e / 2 }
      : d == 'top'
        ? { top: g.top - f, left: g.left + g.width / 2 - e / 2 }
        : d == 'left'
          ? { top: g.top + g.height / 2 - f / 2, left: g.left - e }
          : { top: g.top + g.height / 2 - f / 2, left: g.left + g.width }
  }
  b.prototype.getTitle = function () {
    ...
    f =
      ...
      (typeof e.title == 'function' ? e.title.call(d[0]) : e.title)
    return f
  }
