;+(function (c) {
  ...
  b.prototype.hide = function (d) {
    ...
    c.support.transition && this.$element.hasClass('fade')
      ? this.$element
          .one(c.support.transition.end, c.proxy(this.hideModal, this))
          .emulateTransitionEnd(300)
      : this.hideModal()
  }
  b.prototype.enforceFocus = function () {
    c(document)
      ...
      .on(
        ...
        c.proxy(function (d) {
          if (
            this.$element[0] !== d.target &&
            !this.$element.has(d.target).length
          ) {
            this.$element.focus()
          }
        }, this)
  ...
  b.prototype.backdrop = function (g) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = c('<div class="modal-backdrop ' + e + '" />').appendTo(
        document.body
      )
      this.$element.on(
        'click.dismiss.modal',
      ...
      d
        ? this.$backdrop
            .one(c.support.transition.end, g)
  ...
  c(document).on(
    ...
    function (i) {
      ...
      var g = d.data('modal')
        ? 'toggle'
        : c.extend({ remote: !/#/.test(f) && f }, d.data(), h.data())
      i.preventDefault()
