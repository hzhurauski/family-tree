...
export function OnDataCategoryClick(event) {
    ...
    if (window.g_currentDataCategory == null)
        return;

    if (window.g_currentDataCategory.DataCategoryType == window.DataCategoryTypes.InfoBlock ||
    ...
    else if (window.g_currentDataCategory.DataCategoryType == window.DataCategoryTypes.ListBlock ||
        window.g_currentDataCategory.DataCategoryType == window.DataCategoryTypes.Education ||
        window.g_currentDataCategory.DataCategoryType == window.DataCategoryTypes.ImportantEvents ||
        window.g_currentDataCategory.DataCategoryType == window.DataCategoryTypes.LaborActivities ||
